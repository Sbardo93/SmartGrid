    ...
    public partial class Default : System.Web.UI.Page
    {
        ...
        private List<Oggetto> getData()
        {
            return new List<Oggetto>()
            {
                ...
                new Oggetto("Giulia","Monti","S",new DateTime (1978,6,11)){ID = 3},
                ...
                new Oggetto("Giulia","Monti","S",new DateTime (1978,6,11)){ID = 7},
                ...
                new Oggetto("Giulia","Monti","S",new DateTime (1978,6,11)){ID = 11},
